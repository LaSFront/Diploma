...
__*Поле "Владелец":*__
1. обязательно для заполнения,
2. состоит из двух слов - фамилии и имени, может содержать не менее 1 и не более 30 латинских символов в верхнем и нижнем регистре,
...
**1.1.2.** Успешная операция по покупке тура по карте со сроком окончания действия в текущем месяце текущего года.
...
**1.1.3.** Отказ банка в покупке тура при вводе валидных значений месяца, года, имени владельца, СVC/CVV и номера недействующей карты.
...
__*Ожидаемый результат:*__ Запрос не отправлен. В поле "СVC/CVV" отражается уведомление: "Неверный формат".
...
**1.2.8.** Отправка запроса на покупку тура по карте со сроком окончания действия в месяце, предшествующем текущему месяцу текущего года.
...
**1.2.9.** Отправка запроса на покупку тура при вводе в поле "Месяц" одной цифры.
...
**1.2.10.** Отправка запроса на покупку тура при вводе в поле "Месяц" числа 13.
...
**1.2.11.** Отправка запроса на покупку тура при вводе в поле "Месяц" числа 00.
...
**1.2.12.** Отправка запроса на покупку тура по карте со сроком окончания действия более 5 лет.
...
**1.2.13.** Отправка запроса на покупку тура по карте со сроком окончания действия в прошедшем году.
...
**1.2.14.** Отправка запроса на покупку тура при вводе имени владельца кириллицей.

__*Шаги:*__

- Нажать на странице приложения кнопку "Купить".
- Ввести в поле "Номер карты" номер действующей карты.
- Ввести в поле "Владелец" имя и фамилию кириллическими символами.
...
**1.2.15.** Отправка запроса на покупку тура при вводе имени владельца арабскими цифрами.

__*Шаги:*__

- Нажать на странице приложения кнопку "Купить".
- Ввести в поле "Номер карты" номер действующей карты.
- Ввести в поле "Владелец" значение арабскими цифрами.
- Заполнить поля "Месяц", "Год" и "СVC/CVV" валидными значениями.
- Нажать кнопку "Продолжить".

__*Ожидаемый результат:*__ Запрос не отправлен. В поле "Владелец" отображается уведомление: "Неверный формат".

**1.2.16.** Отправка запроса на покупку тура при вводе в поле "СVC/CVV" одной арабской цифры.
...
**2.1.2.** Успешная операция по покупке тура в кредит по карте со сроком окончания действия в текущем месяце текущего года.
...
**2.1.3.** Отказ банка в покупке тура в кредит при вводе валидных значений месяца, года, имени владельца, СVC/CVV и номера недействующей карты.
...
**2.2.8.** Отправка запроса на покупку тура в кредит по карте со сроком окончания действия в месяце, предшествующем текущему месяцу текущего года.
...
**2.2.9.** Отправка запроса на покупку тура в кредит при вводе в поле "Месяц" одной цифры.
...
**2.2.10.** Отправка запроса на покупку тура в кредит при вводе в поле "Месяц" числа 13.
...
**2.2.11.** Отправка запроса на покупку тура в кредит при вводе в поле "Месяц" числа 00.
...
**1.2.12.** Отправка запроса на покупку тура в кредит по карте со сроком окончания действия более 5 лет.
...
**2.2.13.** Отправка запроса на покупку тура в кредит по карте со сроком окончания действия в прошедшем году.
...
**2.2.14.** Отправка запроса на покупку тура в кредит при вводе имени владельца кириллицей.
...
**2.2.15.** Отправка запроса на покупку тура в кредит при вводе имени владельца арабскими цифрами.
...
**1.2.16.** Отправка запроса на покупку тура в кредит при вводе в поле "СVC/CVV" одной арабской цифры.
