...
**1.1.2.** Отказ банка в покупке тура при вводе валидных значений месяца, года, имени владельца, СVC/CVV и номера недействующей карты.
...
**1.2.8.** Отправка запроса на покупку тура по карте со сроком окончания действия в текущем месяце текущего года.
...
**1.2.15.** Отправка запроса на покупку тура при вводе имени владельца кириллицей.
...
**1.2.16.** Отправка запроса на покупку тура при вводе имени владельца арабскими цифрами.
...
**1.2.17.** Отправка запроса на покупку тура при вводе в поле "СVC/CVV" одной арабской цифры.
...
**2.1.2.** Отказ банка в покупке тура в кредит при вводе валидных значений месяца, года, имени владельца, СVC/CVV и номера недействующей карты.
...
**2.2.8.** Отправка запроса на покупку тура в кредит по карте со сроком окончания действия в текущем месяце текущего года.
...
**1.2.13.** Отправка запроса на покупку тура в кредит по карте со сроком окончания действия более 5 лет.
...
**2.2.15.** Отправка запроса на покупку тура в кредит при вводе имени владельца кириллицей.
...
**2.2.16.** Отправка запроса на покупку тура в кредит при вводе имени владельца арабскими цифрами.
...
**1.2.17.** Отправка запроса на покупку тура в кредит при вводе в поле "СVC/CVV" одной арабской цифры.
