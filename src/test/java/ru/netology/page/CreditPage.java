...
public class CreditPage {
    ...
    //TO DO => input
    public StartPage validCreditActiveCard() {
        activeCard();
        validDate();
        validName();
        validCode();
    ...
    public StartPage rejectionInCreditInactiveCard() {
        inactiveCard();
        validDate();
        validName();
        validCode();
    ...
    public boolean checkNotEmptyField(SelenideElement selenideElement, Condition condition, int num, String
            exactText) {
        try {
